...
const Services = () => {
  ...
  const serviceTable = [
...

    {
      Header: "Status",
      Cell: ({ row }: { row: ServiceData }) => (
        <ToggleSwitch value={row?.isActive} onClick={() => handleStatus(row)} />
      ),
    },
    {
      Header: "Action",
          ...
          <button
            ...
            onClick={() =>
              row?.name !== "All"
                ...
                : DangerRight("This service can not be edited")
            }
          >
            <svg
              width="26"
  ...
  const handleDelete = (row: any) => {
    ...
    if (row?.name === "All") {
      DangerRight("This service can not be deleted");
    }
    ...
    <>
      ...
      <div className="mainCategory">
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-5 col-md-7 col-6  ms-auto">
            <Searching
              type={`server`}
              data={service}
              setData={setData}
