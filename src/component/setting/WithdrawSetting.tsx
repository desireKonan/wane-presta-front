...
interface ErrorState {
  ...
  minWithdrawalRequestedAmount: string;
}
              ...
              >
                ...
                <div className="col-12">
                  <ExInput
                    ...
                    onChange={(e: any) => {
                      setMinWithdrawalRequestedAmount(parseInt(e.target.value));
                      if (!e.target.value) {
                        return setError({
                          ...error,
                          minWithdrawalRequestedAmount: `Minimum withdrawal amount is required`,
                        });
                      } else {
                        return setError({
                          ...error,
